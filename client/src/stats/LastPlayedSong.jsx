                ...
                <div>
                    ...
                    {(typeof song.date == 'undefined') ? (
                        <div className='flex-row flex place-items-center mt-5'>
                            <img src={require('../photos/vinyl.png')} alt="spinning vinyl" className='w-5 animate-spin'></img>
                            <p className='text-xs opacity-40 ml-2'>Currently Listening</p>
                        </div>
                    ) : (
                        <div className='flex-row flex place-items-center mt-5'>
                            <img src={require('../photos/vinyl.png')} alt="spinning vinyl" className='w-5'></img>
                            {(seconds < 3600) ? (
