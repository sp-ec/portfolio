    ...
    return (
        <div className='bg-zinc-900 bg-opacity-90 w-screen -ml-4 -mt-4 pb-6 pt-8 z-50'>
            <div className='flex md:flex-row max-sm:flex-col-reverse justify-center'>
                <div className='basis-1/2 flex flex-row flex-grow z-10 flex-shrink min-w-48 max-w-72 max-h-72 m-8 max-sm:mt-6 max-sm:max-w-none max-sm:max-h-none md:max-w-64 md:max-h-64 sm:max-w-48 sm:max-h-48'>
